...
class FriendFullyActivity : DaggerAppCompatActivity() {

    @Inject
    lateinit var viewModelProvider: Provider<FriendFullyViewModel>
    ...
    class Adapter : RecyclerView.Adapter<Adapter.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val rowDataBinding = DataBindingUtil.inflate<RowFriendFullyBinding>(LayoutInflater.from(parent.context), R.layout.row_friend_fully, parent, false)
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val rowDataBinding: RowFriendFullyBinding? = DataBindingUtil.bind(itemView)
    ...
    @Module
    abstract class FriendFullyActivityModule {
        @ContributesAndroidInjector
        abstract fun contributeFriendFullyActivity(): FriendFullyActivity
    }
}
