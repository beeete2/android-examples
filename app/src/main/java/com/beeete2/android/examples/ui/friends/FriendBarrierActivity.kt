...
import com.beeete2.android.examples.databinding.RowFriendBarrierBinding
import com.beeete2.android.examples.databinding.RowFriendFullyBinding
...
class FriendBarrierActivity : DaggerAppCompatActivity() {

    @Inject
    lateinit var viewModelProvider: Provider<FriendBarrierViewModel>
    ...
    class Adapter : RecyclerView.Adapter<Adapter.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val rowDataBinding = DataBindingUtil.inflate<RowFriendBarrierBinding>(LayoutInflater.from(parent.context), R.layout.row_friend_barrier, parent, false)
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val rowDataBinding: RowFriendBarrierBinding? = DataBindingUtil.bind(itemView)
    ...
    @Module
    abstract class FriendBarrierActivityModule {
        @ContributesAndroidInjector
        abstract fun contributeFriendBarrierActivity(): FriendBarrierActivity
    }
}